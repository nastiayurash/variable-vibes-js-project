  ...
  accordionItems.forEach((item, index) => {
    ...
    button.addEventListener('click', function () {
      ...
      if (isOpen) {
        ...
        icon.querySelector('use').setAttribute('href', './web-force-team-js-project/src/img/icons.svg#icon-arrow-bot');
      } else {
        content.style.maxHeight = '1000px';
        icon.querySelector('use').setAttribute('href', './web-force-team-js-project/src/img/icons.svg#icon-arrow-top');
      }
    });
  });
